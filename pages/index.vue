<template>
    <div class="main landing">
        ...
        <section class="section" v-if="blogs && blogs.latestBlogs && blogs.latestBlogs.length > 0">
            <h3>Blog</h3>
            <div class="teaser-grid">
                <big-teaser v-for="blog in blogs.latestBlogs" :item="blog" :key="blog._uid"></big-teaser>
            </div>
